...
public class JadCombatMethod extends CombatMethod {
	...
	private static final OldProjectile MAGIC_ATTACK_PROJECTILE = new OldProjectile(448, 25, 100, 110, 33);
	...
	public void start(Mobile character, Mobile target) {
        ...
        case MAGIC:
            ...
            Projectile.createProjectile(character, target, MAGIC_ATTACK_PROJECTILE);
            break;
        default:
            break;
		}
